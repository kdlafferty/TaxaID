...
#' version). Bumping that version
#' invalidates every existing row -- confirmed on a real migration
#' affecting ~3,000 rows (PtConception 995;
...
#' rewritten, following this ecosystem's own `.bak_pre_*` backup convention. An
