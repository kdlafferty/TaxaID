...
# optionally audit_barcode_coverage(), and optionally write_reference_fasta().
...
# ===========================================================================
# Part B: Mocked functional tests -- no NCBI
# ===========================================================================
...
test_that("build_site_reference: returns named list with correct components", {
  ...
  expect_named(result, c("reference_df", "census", "unreferenced"))
})
