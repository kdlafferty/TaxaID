...
| accession_col | no | NULL | Character scalar or NULL. Name of the accession column. If NULL (default) the function auto-detects a column named "accession", "Accession", "acc", or "accno". |
