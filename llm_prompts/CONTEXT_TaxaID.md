...
Generated by `TaxaWizard::workflow_export_prompts()` on 2026-09-21 from the packages installed on that machine. Derived, not hand-written -- trust this over any prior knowledge of TaxaID.

## Packages

| Package | Purpose | Version | Built |
|---|---|---|---|
| TaxaTools | Uploads, standardizes and corrects taxonomy across backbones | 0.1.0 | R 4.5.2; ; 2026-09-21 22:07:38 UTC; unix |
| TaxaFetch | Fetch and Prepare Taxonomic Occurrence Data | 0.1.0 | R 4.5.2; ; 2026-09-21 22:07:40 UTC; unix |
| TaxaHabitat | Habitat Assignment and Spatial Quality Control for Taxonomic Occurrences | 0.1.0 | R 4.5.2; ; 2026-09-21 22:07:49 UTC; unix |
| TaxaMatch | Store and Standardize Biological Match Data | 0.1.0 | R 4.5.2; ; 2026-09-21 22:07:42 UTC; unix |
| TaxaLikely | Convert Match Scores to Likelihoods for Taxonomic Assignment | 0.1.0 | R 4.5.2; ; 2026-09-21 22:07:45 UTC; unix |
| TaxaExpect | Kernel Priors for Expected Species Composition from Occurrence Data | 0.1.0 | R 4.5.2; ; 2026-09-21 22:07:47 UTC; unix |
| TaxaAssign | Bayesian Taxonomic Assignment from Match Scores and Priors | 0.1.0 | R 4.5.2; ; 2026-09-21 22:07:58 UTC; unix |
| TaxaFlag | Flag Anomalous Detections in Taxonomic Assignments | 0.1.0 | R 4.5.2; ; 2026-09-21 22:07:59 UTC; unix |
...
- `std_to_priors_kernel`: std_occurrences -> `priors` -- Build priors via site-centered kernel estimation (recommended default) (requires: net:gbif, key:INAT_API_TOKEN)
...
- `match_to_consensus_score`: match_df -> `consensus` -- Score-based consensus only -- fixed score/gap rule (e.g. 100%-match-is-species), no Bayesian priors or LLM (requires: none)
  functions: score_consensus, detect_ranks, create_taxon_names (see CONTEXT_TaxaAssign.md, CONTEXT_TaxaTools.md)
- `match_to_consensus_llm`: match_df -> `consensus` -- LLM-shortcut consensus -- ecological reasoning from context, no trained model or priors needed [wrapper] (requires: key:llm)
...
- `match_to_consensus_bayes`: match_df + model_params + priors -> `consensus` -- Full Bayesian consensus -- trained likelihood model combined with occurrence-based priors [wrapper] (requires: none)
