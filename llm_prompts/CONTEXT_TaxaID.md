...
Generated by `TaxaWizard::workflow_export_prompts()` on 2026-09-24 from the packages installed on that machine. Derived, not hand-written -- trust this over any prior knowledge of TaxaID.

## Packages

| Package | Purpose | Version |
|---|---|---|
| TaxaTools | Uploads, standardizes and corrects taxonomy across backbones | 0.1.0 |
| TaxaFetch | Fetch and Prepare Taxonomic Occurrence Data | 0.1.0 |
| TaxaHabitat | Habitat Assignment and Spatial Quality Control for Taxonomic Occurrences | 0.1.0 |
| TaxaMatch | Store and Standardize Biological Match Data | 0.1.0 |
| TaxaLikely | Convert Match Scores to Likelihoods for Taxonomic Assignment | 0.1.0 |
| TaxaExpect | Kernel Priors for Expected Species Composition from Occurrence Data | 0.1.0 |
| TaxaAssign | Bayesian Taxonomic Assignment from Match Scores and Priors | 0.1.0 |
| TaxaFlag | Flag Anomalous Detections in Taxonomic Assignments | 0.1.0 |
