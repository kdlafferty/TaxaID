...
# Last updated: 2026-06-24 (Session 118 — check_inat_range() added to TaxaFetch; adjust_inat_range_priors() added to TaxaAssign; iNat range-based prior elevation for unobserved taxa)
