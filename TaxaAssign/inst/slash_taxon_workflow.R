...
cat(
  "  irreducible_consensus:", sum(consensus_slash$irreducible_consensus, na.rm = TRUE),
...
consensus_slash |>
  ...
  select(
    observation_id, slash_taxon_name, irreducible_consensus,
...
reducible <- consensus_slash |>
  ...
  select(
    observation_id, slash_taxon_name, n_plausible,
